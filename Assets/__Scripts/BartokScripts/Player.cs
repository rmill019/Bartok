...
[System.Serializable]		// Make the Player class visibile in the Inspector Pane
public class Player {
	...
	public void FanHand()
	{
		...
		for (int i = 0; i < hand.Count; i++)
		{
			...
			// Add the base position of the player's hand (which will be at the bottom-center
			// of the fan of the cards
			pos += handSlotDef.pos;
